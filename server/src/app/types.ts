...
export interface AppSession {userId:string;displayName:string;createdAt:number}
export interface PersistedApplication {version:1;rooms:AppRoom[];sessions:Record<string,AppSession>;roomCommandResults:Record<string,Record<string,JsonObject>>;gameCommandResults:Record<string,Record<string,JsonObject>>}
