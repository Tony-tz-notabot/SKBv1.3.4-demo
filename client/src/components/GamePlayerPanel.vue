...
function chooseSlot(slotId:string,card:DeepReadonly<CardView>|null){if(card&&props.legalCardRefs?.has(card.ref))return;emit("slotSelect",slotId,card);}
const slotEntries=computed(()=>[
  ["weapon1","武1",props.player.equipmentSlots.weapon1],["weapon2","武2",props.player.equipmentSlots.weapon2],["thirdWeapon","武3",props.player.equipmentSlots.thirdWeapon],
