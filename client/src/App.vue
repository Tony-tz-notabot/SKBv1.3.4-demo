...
<template>
  <main class="shell">
    ...
    <GameView v-if="gameSnapshot" :snapshot="gameSnapshot" :events="eventQueue" @execute="gameActions.execute" @preselection="gameActions.setPreselection" @chat="gameActions.sendChat" @forfeit="gameActions.forfeit" />
